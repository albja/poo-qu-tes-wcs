...
// function qui génère un enemie toutes les secondes
...
function animate() {
    ...
    enemies.forEach((enemy, enemyIndex) => {
        ...
        // détecte les collisions entre joueur et ennemies
        ...
        if (distPlayerEnemy - enemy.radius - player.radius <= 0) {
            ...
            bigScoreEl.innerText = score;
            startGameBtn.innerText = "Recommencer la patrie ?";
...
// Un click listener pour ajouter un projectile dans la direction du pointeur
window.addEventListener("click", (event) => {
    ...
    // creatin d'un nouveau projectile
